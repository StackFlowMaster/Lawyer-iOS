...
class PaymentVC: UIViewController {
    ...
    @IBOutlet weak var paymentWrapper: UIView!
    @IBOutlet weak var cardOptionButton: UIButton!
    @IBOutlet weak var cashOptionButton: UIButton!
    ...
    */
    ...
    @IBAction func tapCheckButton(_ sender: UIButton) {
        cardOptionButton.isSelected = sender == cardOptionButton
        cashOptionButton.isSelected = sender == cashOptionButton
    }
    ...
    @IBAction func tapContinueButton(_ sender: UIButton) {
        performSegue(withIdentifier: "ShowCardInfoVC", sender: nil)
    }
}
